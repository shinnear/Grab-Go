  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<OrderRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OrderRecord> cartOrderRecordList = snapshot.data!;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                        ...
                                        child: AuthUserStreamWidget(
                                          builder: (context) => Row(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  'Total Produits Aprés Réduction Anniversaire',
                                                  textAlign: TextAlign.start,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                            ...
                                            builder: (context) => Text(
                                              valueOrDefault<String>(
                                                functions.isAnniversaire(currentUserDocument?.datedenaissance)!
                                                    ? functions.getTotalApres(functions.ajouterFraisLivraison(
                                                        functions.calculerPrixTotal(
                                                            cartOrderRecordList
                                                                .toList(),
                                                            functions.isAnniversaire(
                                                                currentUserDocument
                                                                    ?.datedenaissance))))
                                                    : functions.getTotalAvant(
                                                        functions.ajouterFraisLivraison(
                                                            functions.calculerPrixTotal(
                                                                cartOrderRecordList
                                                                    .toList(),
                                                                functions.isAnniversaire(
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context
                                            .pushNamed(AdresseWidget.routeName);
                                      },
                                      text: 'Place an Order',
