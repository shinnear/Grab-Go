...
import 'viewfeedback_model.dart';
export 'viewfeedback_model.dart';
...
class ViewfeedbackWidget extends StatefulWidget {
  ...
  static String routeName = 'viewfeedback';
  static String routePath = '/viewfeedback';
          ...
          child: Column(
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller: _model.descproductTextController,
                        focusNode: _model.descproductFocusNode,
                        autofocus: false,
                        obscureText: false,
                        ...
                        validator: _model.descproductTextControllerValidator
                            .asValidator(context),
                      ),
                      Column(
                        mainAxisSize: MainAxisSize.max,
                      ...
                      RatingBar.builder(
                        ...
                        initialRating: _model.ratingBarValue1 ??=
                            widget.feedbackdoc!.ratingFood.toDouble(),
              ...
              Align(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 259.0, 0.0),
                  child: Text(
                    'Service rating',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.inter(
                ...
                child: Padding(
                  ...
                  child: RatingBar.builder(
                    ...
                    initialRating: _model.ratingBarValue2 ??=
                        widget.feedbackdoc!.ratingService.toDouble(),
                    unratedColor: FlutterFlowTheme.of(context).accent1,
                    itemCount: 5,
                    itemSize: 24.0,
                    glowColor: FlutterFlowTheme.of(context).primary,
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(FeedbackmanagementWidget.routeName);
                  },
                  text: 'Return',
