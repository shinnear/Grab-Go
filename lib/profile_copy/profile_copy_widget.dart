            ...
            children: [
              Column(
                ...
                children: [
                  Container(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          alignment: AlignmentDirectional(0.88, -0.24),
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                50.0, 0.0, 0.0, 0.0),
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 60.0, 280.0, 0.0),
                    child: Text(
                      'Name:',
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 280.0, 0.0),
                    child: Text(
                      'Email:',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.inter(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                  AddtablereservationWidget.routeName);
                            },
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              mainAxisAlignment: MainAxisAlignment.center,
              ...
              if (FFAppState().sidebarhomeclient)
                Align(
